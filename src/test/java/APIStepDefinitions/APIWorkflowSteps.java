...
public class APIWorkflowSteps {
    ...
    @Given("a request is prepared to create en employee")
    public void a_request_is_prepared_to_create_en_employee() {
      request=given()
    ...
    @Given("a request is prepared to create en employee using json payload")
    public void a_request_is_prepared_to_create_en_employee_using_json_payload() {
        request=given()
                .header(APIConstants.HEADER_KEY_CONTENT_TYPE,
                        APIConstants.HEADER_VALUE_CONTENT_TYPE)
                .header(APIConstants.HEADER_KEY_AUTHORIZATION,
    ...
    public void the_employee_id_is_stored_as_a_global_variable_to_be_used_for_other_calls(String string) {
       // staring the employee id in global variable
        // this path of employee id is coming from feature file
        // you can change the name of parameter if you want
 ...
 //   --------------------------------------------------------------
    ...
    @Then("the employee data we get having id {string} must match with globally stored employee")
    public void the_employee_data_we_get_having_id_must_match_with_globally_stored_employee(String string) {
